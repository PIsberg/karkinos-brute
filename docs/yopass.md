...
Offline recovery of a weak *custom password* on a [yopass](https://github.com/jhaals/yopass)
secret's OpenPGP ciphertext. Source: [`src/target/yopass.rs`](../src/target/yopass.rs)
(general path) and [`src/target/skesk_v6.rs`](../src/target/skesk_v6.rs) (manual
v6 fast path / GPU oracle).
